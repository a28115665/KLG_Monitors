          ...
          link: function ($scope, $elm, $attrs, uiGridCtrl) {
            ...
            function beginEdit() {
              ...
              switch ($scope.col.colDef.type){
                ...
                case 'time':
                  inputType = 'time';
                  html = html.replace('ui-grid-editor', 'ui-grid-editor step="1"');
                  // html = '<div><form name="inputForm"><input type="time" ng-class="\'colt\' + col.uid" ui-grid-editor step="1" ng-model="row.entity[\'CI_Time\']"></form></div>'
                  break;
                case 'datetime-local':
                  inputType = 'datetime-local';
                  html = html.replace('ui-grid-editor', 'ui-grid-editor step="1"');
                  // html = '<div><form name=\"inputForm\"><input type=\"INPUT_TYPE\" ng-class=\"\'colt\' + col.uid\" ui-grid-editor ng-model="row.entity[\'OM_DateTime\']" step="1"></form></div>'
                  break;
              }
    ...
    function ($q, uiGridExporterConstants, uiGridSelectionConstants, gridUtil, $compile, $interval, i18nService) {
      ...
      var service = {
        ...
        downloadFile: function (fileName, csvContent) {
          ...
          var strMimeType = 'application/octet-stream;charset=utf-8,%EF%BB%BF';
          var rawFile;
          ...
          //20150108 csv可以匯出中文
  		    rawFile = 'data:text/csv;charset=utf-8,%EF%BB%BF' + encodeURI(csvContent);
