...
angular.module('app.forum', [])
	...
	.directive('myBranchDropdown', function() {
		return {
			template: '<select id="filterDropdown" class="form-control" ng-model="colFilter.term" ng-options="option.id as option.M_Branch for option in colFilter.options"></select>'
		};
	})
